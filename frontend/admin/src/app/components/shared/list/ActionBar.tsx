  ...
  return (
    <div className="mb-[30px]">
      <div className="flex flex-wrap gap-[20px] items-center">
        ...
        <Link
          href={createLink}
          className="inline-flex items-center justify-center bg-[var(--color-primary)] rounded-[14px] px-[30px] h-[71px] font-[700] text-[14px] text-white hover:opacity-90 transition-opacity"
        >
          + Tạo mới
        </Link>
        ...
        <Link
          href={trashLink}
          className="inline-flex items-center justify-center bg-[#EF382633] rounded-[14px] px-[30px] h-[71px] font-[700] text-[14px] text-[#EF3826] hover:bg-[#EF382655] transition-colors"
        >
          Thùng rác
        </Link>
      </div>
